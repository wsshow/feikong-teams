...
Skills 是一组指令、脚本和资源的集合，fkteams(coordinator) 可以动态加载这些 Skills 来提升在特定任务上的表现。Skills 教会 fkteams(coordinator) 如何以可重复的方式完成特定任务，无论是按照公司的品牌指南创建文档，还是使用组织特定的工作流程分析数据，或者自动化个人任务。
